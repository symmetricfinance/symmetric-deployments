...
const timestamp = BigNumber.from('1739404800');

const approvals = [
  {
    token: '0xD102cE6A4dB07D247fcc28F366A623Df0938CA9E',
    amount: BigNumber.from('5706521739130440000000'),
  },
  {
...
const veApprovals = [
  {
    token: '0xD102cE6A4dB07D247fcc28F366A623Df0938CA9E',
    amount: BigNumber.from('3043478260869570000000'),
  },
  {
    token: '0x8f7D64ea96D729EF24a0F30b4526D47b80d877B9',
  ...
  [
    {
      ...
      rate: BigNumber.from('1521739130434780000000'),
      period_finish: 0,
      decimals: 18,
    },
  ],
  [
    {
      ...
      rate: BigNumber.from('1141304347826090000000'),
      period_finish: 0,
      decimals: 18,
    },
  ],
  [
    {
      ...
      rate: BigNumber.from('3043478260869570000000'),
      period_finish: 0,
      decimals: 18,
    },
    {
